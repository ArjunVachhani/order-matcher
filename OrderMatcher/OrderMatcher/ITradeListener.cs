...
public interface ITradeListener
{
    ...
    void OnSelfMatch(OrderId incomingOrderId, OrderId restingOrderId, UserId userId);
    void OnDecrement(OrderId orderId, UserId userId, Quantity quantityDecremented);
