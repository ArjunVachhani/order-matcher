...
public class MatchingEngineLimitGoodTillDateBookOrCancelOrderTests
{
    private readonly Mock<ITradeListener> mockTradeListener;
    private readonly Mock<IFeeProvider> mockFeeProcider;
    private MatchingEngine matchingEngine;
    public MatchingEngineLimitGoodTillDateBookOrCancelOrderTests()
    {
    ...
    {
        Order order1 = new Order { IsBuy = true, OpenQuantity = 500, Price = 10, OrderId = 1, UserId = 1, CancelOn = 1, OrderCondition = OrderCondition.BookOrCancel };
    ...
    {
        Order order1 = new Order { IsBuy = true, OpenQuantity = 500, Price = 10, OrderId = 1, UserId = 1, CancelOn = 10, OrderCondition = OrderCondition.BookOrCancel };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 10);
    ...
    {
        Order order1 = new Order { IsBuy = true, OpenQuantity = 500, Price = 10, OrderId = 1, UserId = 1, CancelOn = 11, OrderCondition = OrderCondition.BookOrCancel };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 10);
    ...
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 500, Price = 10, OrderId = 1, UserId = 1, CancelOn = 10, OrderCondition = OrderCondition.BookOrCancel };
