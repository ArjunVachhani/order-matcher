...
namespace OrderMatcher.Tests
{
    public class MatchingEngineStopImmediateOrCancelOrderTests
    {
        ...
        [InlineData(10)]
        [InlineData(0)]
        public void AddOrder_Cancels_ImmediateOrCancel_If_StopOrder(int price)
        {
            ...
            Order order2 = new Order { IsBuy = true, OpenQuantity = 500, Price = price, OrderId = 2, UserId = 2, OrderCondition = OrderCondition.ImmediateOrCancel, StopPrice = 1000 };
