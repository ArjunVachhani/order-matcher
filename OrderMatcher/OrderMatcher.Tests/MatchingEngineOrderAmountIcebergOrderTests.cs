...
namespace OrderMatcher.Tests
{
    public class MatchingEngineOrderAmountIcebergOrderTests
    {
        ...
        {
            Order order1 = new Order { IsBuy = true, OrderId = 1, UserId = 1, Price = 0, OpenQuantity = 0, TipQuantity = 1, TotalQuantity = 10, OrderAmount = 1 };
            OrderMatchingResult accepted = matchingEngine.AddOrder(order1, 1);
            Assert.Equal(OrderMatchingResult.IcebergOrderCannotBeMarketOrStopMarketOrder, accepted);
