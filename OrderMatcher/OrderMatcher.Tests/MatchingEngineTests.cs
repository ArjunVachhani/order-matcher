...
namespace OrderMatcher.Tests
{
    public class MatchingEngineTests
    {
        ...
        public void CancelOrder_CancelsFullOrder_IfNoFillIcebergOrderBuySide()
        {
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)4500, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order1.OrderId).Value.TotalQuantity);
            Assert.Equal((ulong)0, order1.Sequnce);
        ...
        public void CancelOrder_CancelCorrectAmount_IfIcebergOrderPartiallyFilledBuy()
        {
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)4000, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order1.OrderId).Value.TotalQuantity);
            Assert.Equal((Quantity)0, order2.OpenQuantity);
            Assert.Equal((ulong)0, order2.Sequnce);
        ...
        public void CancelOrder_CancelsCorrectAmount_IfLastTipIsPartiallyRemainingBuy()
        {
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)700, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order1.OrderId).Value.TotalQuantity);
            Assert.Equal((ulong)0, order1.Sequnce);
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)200, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order1.OrderId).Value.TotalQuantity);
            Assert.Equal((Quantity)0, order2.OpenQuantity);
            Assert.Equal((ulong)0, order2.Sequnce);
        ...
        public void CancelOrder_RejectsRequest_IfIcebergOrderMatchedFully()
        {
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)1000, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order1.OrderId).Value.TotalQuantity);
            Assert.Equal((ulong)0, order1.Sequnce);
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)500, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order1.OrderId).Value.TotalQuantity);
            Assert.Equal((Quantity)0, order2.OpenQuantity);
            Assert.Equal((ulong)0, order2.Sequnce);
        ...
        public void AddOrder_AddsTip_IfIcebergeOrderTipIsMatchedSell()
        {
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)500, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order2.OrderId).Value.TotalQuantity);
            Assert.Equal((ulong)0, order2.Sequnce);
        }
        ...
        public void AddOrder_AddsMoreTip_IfIcebergeOrderTipIsMatchedSell()
        {
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)500, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order3.OrderId).Value.TotalQuantity);
            Assert.Equal((ulong)0, order3.Sequnce);
        }
        ...
        public void AddOrder_AddsTip_IfIcebergeOrderTipIsMatchedWithMultipleOrderSell()
        {
            ...
            Assert.Empty(matchingEngine.Book.StopAskSide);
            Assert.Empty(matchingEngine.Book.StopBidSide);
            Assert.Equal((Quantity)3500, matchingEngine.CurrentIcebergOrders.Single(x => x.Key == order3.OrderId).Value.TotalQuantity);
            Assert.Equal((ulong)0, order3.Sequnce);
        }
        ...
        public void CancelOrder_Stop_Market_Order_Amount_Order_Entered_In_Stop_Book_With_Market_Rate_For_Buy()
        {
            ...
            Order order3 = new Order { IsBuy = true, OrderAmount = 500, Price = 0, OrderId = 3, IsStop = true };
            var orderWrapper3 = new OrderWrapper { Order = order3, StopPrice = 11 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(orderWrapper3);
        ...
        {
            Order order1 = new Order { IsBuy = true, OrderAmount = 1000, Price = 0, OrderId = 1, IsStop = true };
            var orderWrapper1 = new OrderWrapper { Order = order1, StopPrice = 9 };
            OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(orderWrapper1);
        ...
        public void AddOrder_Stop_Market_Order_Amount_Order_Entered_In_Stop_Book_With_Market_Rate_For_Buy()
        {
            ...
            Order order3 = new Order { IsBuy = true, OrderAmount = 5000, Price = 0, OrderId = 3, IsStop = true };
            var orderWrapper3 = new OrderWrapper { Order = order3, StopPrice = 11 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(orderWrapper3);
        ...
        public void AddOrder_Stop_Market_Order_Amount_Trigger_And_Matches_As_Taker_Buy()
        {
            ...
            Order order3 = new Order { IsBuy = true, OrderAmount = 5500, Price = 0, OrderId = 3, IsStop = true };
            var orderWrapper3 = new OrderWrapper { Order = order3, StopPrice = 11 };
            OrderMatchingResult result3 = matchingEngine.AddOrder(orderWrapper3);
        ...
        public void AddOrder_CancelsFullQuantityFOKMarketOrderAmount_IfNotEnoughSellAvailable()
        {
            ...
            Order order5 = new Order { IsBuy = true, OrderAmount = 6000, Price = 0, OrderId = 5 };
            var orderWrapper5 = new OrderWrapper { Order = order5, OrderCondition = OrderCondition.FillOrKill };
            OrderMatchingResult acceptanceResult5 = matchingEngine.AddOrder(orderWrapper5);
        ...
        public void AddOrder_FillsFullQuantityFOKMarketOrderAmount_IfNotEnoughSellAvailable()
        {
            ...
            Order order5 = new Order { IsBuy = true, OrderAmount = 4000, Price = 0, OrderId = 5 };
            var orderWrapper5 = new OrderWrapper { Order = order5, OrderCondition = OrderCondition.FillOrKill };
            OrderMatchingResult acceptanceResult5 = matchingEngine.AddOrder(orderWrapper5);
