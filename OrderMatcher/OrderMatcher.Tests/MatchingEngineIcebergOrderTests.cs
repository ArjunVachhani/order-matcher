...
public class MatchingEngineIcebergOrderTests
{
    ...
    {
        Order order1 = new Order { IsBuy = true, OrderId = 1, UserId = 1, OpenQuantity = 1000, TotalQuantity = -10, TipQuantity = 1000 };
    ...
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 1500, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
        ...
        mockTradeListener.Verify(x => x.OnAccept(order3.OrderId, order3.UserId));
        mockTradeListener.Verify(x => x.OnTrade(3, 1, 3, 1, true, 10, 500, null, null, 5000, 25));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult3);
        Assert.Contains(order1.OrderId, matchingEngine.Book.AskSide.SelectMany(x => x).Select(x => x.OrderId).ToList());
        Assert.Equal(500, matchingEngine.Book.AskSide.SelectMany(x => x).Where(x => x.OrderId == 1).Single().OpenQuantity);
        ...
        mockTradeListener.Verify(x => x.OnTrade(4, 1, 4, 1, true, 10, 500, 0, 30, 5000, 25));
        mockTradeListener.VerifyNoOtherCalls();
    ...
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 5000, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
    ...
    [Fact]
    public void AddOrder_SetsTipQuantityToOpenQuantityIfOpenQuantity0_ForIcebergOrders()
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 1500, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
    ...
    [Fact]
    public void AddOrder_DoesnotSetsTipQuantityToOpenQuantityIfOpenQuantityNonZero_ForIcebergOrders()
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 100, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 1500, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
        ...
        Assert.Empty(matchingEngine.Book.StopAskSide);
        Assert.Empty(matchingEngine.Book.StopBidSide);
        Assert.Equal(1500, matchingEngine.CurrentOrders.Single(x => x.OrderId == order1.OrderId).TotalQuantity);
        Assert.Equal((ulong)1, order1.Sequence);
    }

    [Fact]
    public void CancelOrder_IcebergWithOpenQuantity_ForIcebergOrders()
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 100, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 1500, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
        ...
        mockTradeListener.Verify(x => x.OnCancel(1, 1, 1600, 0, 0, CancelReason.UserRequested));
    ...
    public void AddOrder_AddsTip_IfIcebergeOrderTipIsMatchedSell()
    {
        ...
        Order order2 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 2, UserId = 2, TotalQuantity = 1500, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult2 = matchingEngine.AddOrder(order2, 2);
    ...
    public void AddOrder_AddsMoreTip_IfIcebergeOrderTipIsMatchedSell()
    {
        ...
        Order order3 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 3, UserId = 3, TotalQuantity = 1500, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult3 = matchingEngine.AddOrder(order3, 3);

        mockTradeListener.Verify(x => x.OnAccept(order3.OrderId, order3.UserId));
        mockTradeListener.Verify(x => x.OnTrade(3, 1, 3, 1, false, 10, 500, null, null, 5000, 10));
        mockTradeListener.Verify(x => x.OnTrade(3, 2, 3, 2, false, 10, 400, null, null, 4000, 8));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult3);
    ...
    public void AddOrder_AddsAllTip_IfIcebergeOrderTipIsMatchedSell()
    {
        ...
        mockTradeListener.Verify(x => x.OnAccept(order4.OrderId, order4.UserId));
        mockTradeListener.Verify(x => x.OnTrade(4, 2, 4, 2, false, 11, 400, null, null, 4400, 8.8m));
        mockTradeListener.Verify(x => x.OnTrade(4, 1, 4, 1, false, 10, 100, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(4, 1, 4, 1, false, 10, 400, null, null, 5000, 10));
        mockTradeListener.Verify(x => x.OnTrade(4, 3, 4, 3, false, 10, 100, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(4, 3, 4, 3, false, 10, 500, 0, 77, 6000, 12));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult4);
    ...
    public void AddOrder_AddsAllTip_IfIcebergeOrderTipIsMatchedWithSingleHugeOrderSell()
    {
        ...
        Order order2 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 2, UserId = 2, TotalQuantity = 5000, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult2 = matchingEngine.AddOrder(order2, 2);

        mockTradeListener.Verify(x => x.OnAccept(order2.OrderId, order2.UserId));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, null, null, null, null));
        ...
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, false, 10, 500, 0, 250, 50000, 100));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult2);
        Assert.Empty(matchingEngine.CurrentOrders);
        Assert.Empty(matchingEngine.CurrentOrders);
    ...
    public void AddOrder_AddsTip_IfIcebergeOrderTipIsMatchedWithMultipleOrderSell()
    {
        ...
        Order order3 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 3, UserId = 3, TotalQuantity = 5000, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult3 = matchingEngine.AddOrder(order3, 3);

        mockTradeListener.Verify(x => x.OnAccept(order3.OrderId, order3.UserId));
        mockTradeListener.Verify(x => x.OnTrade(3, 1, 3, 1, false, 10, 500, null, null, 5000, 10));
        mockTradeListener.Verify(x => x.OnTrade(3, 2, 3, 2, false, 10, 500, null, null, 5000, 10));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult3);
        Assert.Contains(order3.OrderId, matchingEngine.CurrentOrders.Select(x => x.OrderId));
        Assert.Contains(order3.OrderId, matchingEngine.AcceptedOrders);
    ...
    public void AddOrder_AddsTip_IfIcebergeOrderTipIsMatchedWithFullyOrderSell()
    {
        ...
        Order order3 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 3, UserId = 3, TotalQuantity = 1000, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult3 = matchingEngine.AddOrder(order3, 3);

        mockTradeListener.Verify(x => x.OnAccept(order3.OrderId, order3.UserId));
        mockTradeListener.Verify(x => x.OnTrade(3, 1, 3, 1, false, 10, 500, null, null, 5000, 10));
        mockTradeListener.Verify(x => x.OnTrade(3, 2, 3, 2, false, 10, 500, 0, 50, 5000, 10));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult3);
        Assert.Empty(matchingEngine.CurrentOrders);
        Assert.Empty(matchingEngine.CurrentOrders);
    ...
    [Fact]
    public void AddOrder_RejectsOrder_TipQuantityMoreThanTotalQuantity()
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 409, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
    ...
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 500, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
    ...
    public void AddOrder_Rejects_QuantityNotMultipleOfStepSize_Order()
    {
        ...
        Order order1 = new Order { IsBuy = true, OrderId = 1, UserId = 1, OpenQuantity = 100.1m, Price = 10, TotalQuantity = 10000m, TipQuantity = 2000 };
        OrderMatchingResult accepted = matchingEngine.AddOrder(order1, 1);
    ...
    {
        matchingEngine = new MatchingEngine(mockTradeListener.Object, mockFeeProcider.Object, 0.5m, 0);
        Order order1 = new Order { IsBuy = true, OrderId = 1, UserId = 1, OpenQuantity = 0, Price = 10, TotalQuantity = 10000.1m, TipQuantity = 200 };
        OrderMatchingResult accepted = matchingEngine.AddOrder(order1, 1);
        Assert.Equal(OrderMatchingResult.QuantityAndTotalQuantityShouldBeMultipleOfStepSize, accepted);
        Assert.DoesNotContain(order1.OrderId, matchingEngine.AcceptedOrders);
    }
    ...
    [Fact]
    public void AddOrder_Rejects_TipQuantityNotMultipleOfStepSize_Order()
    {
        matchingEngine = new MatchingEngine(mockTradeListener.Object, mockFeeProcider.Object, 0.5m, 0);
        Order order1 = new Order { IsBuy = true, OrderId = 1, UserId = 1, OpenQuantity = 200, Price = 10, TotalQuantity = 10000m, TipQuantity = 200.1m };
        OrderMatchingResult accepted = matchingEngine.AddOrder(order1, 1);
        Assert.Equal(OrderMatchingResult.QuantityAndTotalQuantityShouldBeMultipleOfStepSize, accepted);
        Assert.DoesNotContain(order1.OrderId, matchingEngine.AcceptedOrders);
    }
    ...
    public void AddOrder_Rejects_QuantityNotMultipleOfStepSize2_Order()
    {
        ...
        Order order1 = new Order { IsBuy = true, OrderId = 1, UserId = 1, OpenQuantity = 0, Price = 10, TotalQuantity = 10000, TipQuantity = 1000 };
        OrderMatchingResult accepted = matchingEngine.AddOrder(order1, 1);
        Assert.Equal(OrderMatchingResult.QuantityAndTotalQuantityShouldBeMultipleOfStepSize, accepted);
        Assert.DoesNotContain(order1.OrderId, matchingEngine.AcceptedOrders);
    }
    ...
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 1, UserId = 1, TipQuantity = 500, TotalQuantity = 1200 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
        ...
        mockTradeListener.Verify(x => x.OnAccept(order4.OrderId, order4.UserId));
        mockTradeListener.Verify(x => x.OnTrade(4, 1, 4, 1, true, 10, 100, null, null, 1000, 5));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult4);
        Assert.Contains(order1.OrderId, matchingEngine.Book.AskSide.SelectMany(x => x).Select(x => x.OrderId).ToList());
        Assert.Equal(100, matchingEngine.Book.AskSide.SelectMany(x => x).Where(x => x.OrderId == 1).Single().OpenQuantity);
    ...
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 0, Price = 10, OrderId = 1, UserId = 1, TotalQuantity = 1200, TipQuantity = 500 };
        OrderMatchingResult acceptanceResult = matchingEngine.AddOrder(order1, 1);
    ...
    public void AddOrder_AddedAllTip_IfMatchedWithHugeOrder()
    {
        ...
        mockTradeListener.Verify(x => x.OnAccept(order2.OrderId, order2.UserId));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, null, null, null, null));
        ...
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, null, null, null, null));
        mockTradeListener.Verify(x => x.OnTrade(2, 1, 2, 1, true, 10, 500, 0, 100, 50000, 250));
        mockTradeListener.VerifyNoOtherCalls();
        Assert.Equal(OrderMatchingResult.OrderAccepted, acceptanceResult2);
        Assert.Empty(matchingEngine.CurrentOrders);
        Assert.Empty(matchingEngine.CurrentOrders);
