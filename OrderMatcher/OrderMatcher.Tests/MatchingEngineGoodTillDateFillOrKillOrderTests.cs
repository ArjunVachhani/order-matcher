...
public class MatchingEngineGoodTillDateFillOrKillOrderTests
{
    private readonly Mock<ITradeListener> mockTradeListener;
    private readonly Mock<IFeeProvider> mockFeeProcider;
    private MatchingEngine matchingEngine;
    public MatchingEngineGoodTillDateFillOrKillOrderTests()
    {
    ...
    [Fact]
    public void AddOrder_Rejects_FillOrKill_If_GTDOrder()
    {
        Order order1 = new Order { IsBuy = false, OpenQuantity = 500, Price = 10, OrderId = 1, UserId = 1, CancelOn = 10, OrderCondition = OrderCondition.FillOrKill };
