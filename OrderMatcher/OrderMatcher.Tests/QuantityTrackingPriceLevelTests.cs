...
namespace OrderMatcher.Tests
{
    public class QuantityTrackingPriceLevelTests
    {
        ...
        public void AddOrder_AddsOrder()
        {
            ...
            Order order1 = new Order() { IsBuy = true, OrderId = 1, Price = 100, Sequnce = 1, OpenQuantity = 1000 };
            ...
            Order order2 = new Order() { IsBuy = true, OrderId = 2, Price = 100, Sequnce = 2, OpenQuantity = 1000 };
        ...
        public void RemoveOrder_RemovesOrder()
        {
            ...
            Order order3 = new Order() { IsBuy = true, OrderId = 3, Price = 100, Sequnce = 3, OpenQuantity = 1000 };
            ...
            Order order4 = new Order() { IsBuy = true, OrderId = 4, Price = 100, Sequnce = 4, OpenQuantity = 1000 };
        ...
        {
            QuantityTrackingPriceLevel quantityTrackingPriceLevel = new QuantityTrackingPriceLevel(100);
            Order order1 = new Order() { IsBuy = true, OrderId = 1, Price = 100, Sequnce = 2, OpenQuantity = 1000 };
            quantityTrackingPriceLevel.AddOrder(order1);

            Assert.Equal(1000, quantityTrackingPriceLevel.Quantity);
            Assert.Equal(1, quantityTrackingPriceLevel.OrderCount);

            Order order2 = new Order() { IsBuy = true, OrderId = 2, Price = 100, Sequnce = 1, OpenQuantity = 1000 };
            quantityTrackingPriceLevel.AddOrder(order2);
