...
{
    public class PriceComparerDescendingZeroFirstTests
    {
        [Fact]
        ...
        [Fact]
        public void Compare_ReturnsPositive_IfSecondArguementIsLarger()
        {
            PriceComparerDescendingZeroFirst comparer = new PriceComparerDescendingZeroFirst();
        ...
        [Fact]
        public void Compare_ReturnsNegative_IfFirstArguementIs0()
        {
            PriceComparerDescendingZeroFirst comparer = new PriceComparerDescendingZeroFirst();
        ...
        public void SortedDictionarySortsDescendingPriceLevel()
        {
            ...
            List<PriceLevel> expectedPriceLevelSortOrder = new List<PriceLevel>() { level0, level5, level4, level3, level2, level1 };
            AssertHelper.SequentiallyEqual(expectedPriceLevelSortOrder, sortedDictionary.Values.ToList());

            List<Price> expectedPriceSortOrder = new List<Price>() { price0, price5, price4, price3, price2, price1 };
        ...
        public void SortedDictionarySortsDescendingQuantityTrackingPriceLevel()
        {
            ...
            List<QuantityTrackingPriceLevel> expectedPriceLevelSortOrder = new List<QuantityTrackingPriceLevel>() { level0, level5, level4, level3, level2, level1 };
            AssertHelper.SequentiallyEqual(expectedPriceLevelSortOrder, sortedDictionary.Values.ToList());
